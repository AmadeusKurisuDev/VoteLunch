...
<form method="POST">
    <?php
        ...
        while($row=mysqli_fetch_array($ris)){
            echo "<h2><input id='".$row['id']."' name='scelta' type='radio' value='".$row['nome']."'/><label for='".$row['id']."'>".$row['nome']."</label></h2><br>";
        }
    ?>
    <button class="pulsante" type="submit"><h1>Invia</h1></button>
</form>
<br><br><br><br>
<?php
